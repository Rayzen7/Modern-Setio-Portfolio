...
const Contact = () => {
  ...
  return (
    <div className="w-full h-[100vh] pt-10" id="contact" data-aos="fade-up" data-aos-duration="700">
      <h1 className="text-center font-poppins font-[600] text-[45px]">Contact</h1>
        ...
        <div>
          <form onSubmit={handleSubmit} className="flex flex-col justify-center items-start gap-8">
            <input
              ...
              placeholder="Name"
              required
              className="w-[500px] h-[50px] pl-5 rounded-md bg-transparent"
              style={{ border: "2px solid rgba(255, 255, 255, 0.125)" }}
            />
            <textarea
              placeholder="Message"
              required
              className="w-[500px] h-[230px] bg-transparent rounded-md pl-5 pt-3"
              style={{ border: "2px solid rgba(255, 255, 255, 0.125)" }}
            ></textarea>
            <button type="submit">
